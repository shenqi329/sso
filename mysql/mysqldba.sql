...
CREATE TABLE `t_user` (
  ...
  `t_user_create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '注册时间',
  `t_user_update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改日期',
...
CREATE TABLE `t_token` (
  ...
  `t_token_create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '生成时间',
  `t_token_expaired_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '修改日期',
